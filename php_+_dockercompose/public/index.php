...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" integrity="sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZ$</head>
<body>
       ...
       <form action="registrar.php" method="post" class="form_register" >
        ...
        <div class="contenedor_inputs">
           ...
           <input type="text" name="apellidos" placeholder="apellidos" class="input-100" required>
            ...
            <input type="int" name="monto" placeholder="monto" class="input-100" required>
            <input type="int" name="grupo" placeholder="grupo" class="input-100" required>
